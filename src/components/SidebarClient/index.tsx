              ...
              {connectedUser?.AlreadyCompany ? (
                <>
                  <a
                    ...
                    className="hover:scale-[1.05] cursor-pointer inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                ...
                <Link to="/SwitchToCompany">
                  {' '}
                  <a className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    {connectedUser?.role == 'challenger' ? (
                      <>Switch to company</>
                    ) : (
                      <>Switch to challenger</>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/profile"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                          (pathname === '/profile' ||
                            pathname === '/settings') &&
                          'text-white bg-primary dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              {connectedUser?.role == 'challenger' && (
                <>
                  <SidebarLinkGroup
                    activeCondition={pathname.includes('teams')}
                  >
                    {(handleClick, open) => {
                      return (
                        <React.Fragment>
                          <NavLink
                            to="/teams/myInvitations"
                            className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
              ...
              {connectedUser?.role === 'company' && (
                <li>
                  <NavLink
                    to={`${connectedUser?.role == 'company' ? '/Participants' : '/Participants'} `}
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium rounded-2 focus:bg-primary focus:text-white focus:font-bold text-black duration-300 ease-in-out hover:bg-gray-100 dark:hover:bg-meta-4  ${
              ...
              <div className="flex flex-col space-x-2">
                ...
                <ul>
                  {connectedUser.skills.map((skill, index) => (
                    <li
                      key={index}
                      className="hover:scale-[1.05] cursor-pointer  hover:m-1 bg-gray-300 text-primary font-semibold p-2 rounded-full m-0.5 border border-gray-200 text-xs inline-block"
                    >
                      {skill}
                    </li>
                  ))}
