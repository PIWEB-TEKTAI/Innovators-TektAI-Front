...
import Logo from '../../images/logo/logo-tekt-gray2-nobg.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
    ref={sidebar}
    className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#2F3365] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
      sidebarOpen ? 'translate-x-0' : '-translate-x-full'
    }`}
    style={{background: 'url("/src/images/y1.gif") center center / cover no-repeat'  }}
  >
