...
import { faAdd, faBars, faBorderNone, faCheck, faCircleExclamation, faCircleStop, faPenNib, faPencil, faRemove, faRoadBarrier, faStop, faTrash, faUser, faUsers } from '@fortawesome/free-solid-svg-icons';
