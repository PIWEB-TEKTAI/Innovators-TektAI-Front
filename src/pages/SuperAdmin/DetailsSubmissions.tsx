...
const CardSubmission: React.FC<{ submission: Submission }> = ({ submission }) => {
    ...
    function fetchChallenge(challenge: any) {
        axios.get(`http://localhost:3000/challenges/challenges/${challenge}`)
            .then(response => {
    ...
    function fetchSubmittedUser(submittedBy: any) {
        axios.get(`http://localhost:3000/user/getById/${submittedBy}`)
            .then(response => {
...
export default function FetchData() {
    ...
    const fetchData = () => {
        axios.get(`http://localhost:3000/submissions/SubmissionsDetails/${id}`)
            .then(response => {
