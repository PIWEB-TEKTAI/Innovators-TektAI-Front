  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
    <div className="text-center">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-[1.2] hover:shadow-xl">
          <div className="px-6 py-8">
            <h3 className="text-xl font-semibold text-white mb-2">Industry-Leading Expertise</h3>
            <p className="text-white">With years of experience in the data science industry, we understand the unique challenges and opportunities that businesses and data science professionals face. Our team of experts brings unparalleled knowledge and insights to every project and challenge.</p>
          </div>
        </div>
        {/* Card 2: Comprehensive Solutions */}
        <div className="bg-gradient-to-br from-yellow-400 to-orange-500 rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-[1.2] hover:shadow-xl">
          <div className="px-6 py-8">
            <h3 className="text-xl font-semibold text-white mb-2">Comprehensive Solutions</h3>
            <p className="text-white">TektAI offers a comprehensive suite of solutions designed to meet the diverse needs of companies and data science professionals. From data science challenges to collaborative projects and access to a global talent pool, we provide everything you need to succeed in today's data-driven world.</p>
          </div>
        </div>
        {/* Card 3: Collaborative Environment */}
        <div className="bg-gradient-to-br from-green-400 to-blue-500 rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-[1.2] hover:shadow-xl">
          <div className="px-6 py-8">
            <h3 className="text-xl font-semibold text-white mb-2">Collaborative Environment</h3>
            <p className="text-white">We believe in the power of collaboration to drive innovation. Our platform provides a collaborative environment where companies and data science professionals can come together to solve real-world challenges, share knowledge, and push the boundaries of what's possible.</p>
          </div>
        </div>
        {/* Card 4: Global Reach */}
        <div className="bg-gradient-to-br from-pink-400 to-red-500 rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-[1.2] hover:shadow-xl">
          <div className="px-6 py-8">
            <h3 className="text-xl font-semibold text-white mb-2">Global Reach</h3>
            <p className="text-white">With a global community of data science professionals and companies, TektAI offers unparalleled access to talent and opportunities from around the world. No matter where you are, you can connect with top talent and exciting projects right at your fingertips.</p>
          </div>
        </div>
      </div>
    </div>
