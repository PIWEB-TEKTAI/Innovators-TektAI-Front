   ...
   const handleSendMessage = async (userId) => {
    ...
    return (
        <div className='w-screen flex' >
            ...
            <div className='w-[60%] bg-white h-screen shadow-lg flex flex-col items-center py-4' >
                <div className='w-3/4 bg-slate-100 h-16 mt-14 rounded-full flex items-center px-4' hidden={!fetchMessage}>
                    <img src={RecevirUser?.image} width={50} height={50} className="rounded-full mr-4 cursor-pointer" alt="Avatar" />
                    <div className='ml-6 mr-auto'>
                        <h3 className='text-lg'>{RecevirUser?.firstname} {RecevirUser?.lastname}</h3>
                        <p className='text-sm font-light text-gray-600'>{RecevirUser?.email}</p>
                    </div>
                    <div className='cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone-call" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#326A85" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    messages.length > 0 ? (
        ...
        <div className='text-center text-lg font-semibold mt-24'>No Messages or No Conversation selected  </div>
                ...
                <div className="p-4 w-full bg-gray-100 flex items-center ">
                    <input
                        type="text"
                        value={msg}
