      ...
      <div className='bg-white rounded-lg p-4'>
        ...
        {invitations.map(invitation => (
          <div key={invitation._id}>
            <div className="flex items-center my-4 rounded-full bg-gray-50 p-4 max-w-[90%]">
              <div className="flex cursor-pointer" onClick={() => navigateToTeamDetails(invitation._id)}>
              ...
              <div className="flex justify-end ml-auto">
                <button onClick={() => acceptInvitation(invitation._id)} className="mr-2 bg-green-500 text-white font-semibold text-xs rounded-full px-2 py-1">Accept</button>
                <button onClick={() => rejectInvitation(invitation._id)} className='bg-red-500 text-white font-semibold text-xs rounded-full px-2 py-1'>Reject</button>
              </div>
            </div>
            <ul>
