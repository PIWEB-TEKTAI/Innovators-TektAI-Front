...
import { createConverstation } from '../../services/converstation.services';
...
const OtherUserProfile = () => {
  ...
  const handleCreateConverstation = async (e:any) => {
      e.preventDefault();
    
      createConverstation(userAuth?._id , userId)
        .then((response) => {
          console.log('converstation added successfully:', response);
          setTimeout(() => {
        ...
        .catch((error) => {
          ...
          console.error('Error adding converstation:', error);
  ...
  return (
    <ClientLayout>
      <div className="overflow-hidden rounded-sm sm:mx-[10rem] border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img
                src={imageUrl || profileData?.imageUrl}
                alt="profile"
                className="rounded-full max-h-36 w-40"
              />
            </div>
          </div>
          <Modal
            ...
            {profileData?.address ? (
              <>
                <span className="text-sm">
                  {profileData?.address.toLocaleUpperCase()}
                </span>
              </>
            ) : (
              <>
              ...
              <>
                ...
                <div className="text-center mt-4">
                  ...
                  <div className="mx-auto max-w-180">
                    ...
                    <p className="mt-4.5 mb-5.5">{profileData?.Description}</p>
                  </div>
                ...
                <div className="text-start p-3">
                  <div className="px-3">
                    ...
                    <div className="mx-auto max-w-180">
                      ...
                      <div className="grid grid-cols-5 gap-8 pt-3">
                        ...
                        <div className="col-span-5 xl:col-span-2">
                          ...
                          <div className="flex">
                            ...
                            <span>
                              {profileData?.company?.professionnalFields}
                            </span>
                          </div>
                        </div>
                      </div>
