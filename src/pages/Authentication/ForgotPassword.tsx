      ...
      axios
        ...
        .then((res) => {
          if (res.data.Status === 'Success') {
            setSuccessMessage(
              'Password reset link sent successfully.If you did not receive it, please check your spam folder. If it is not there, you can resend the email.',
            );
            setErrorMessage('');
          } else {
            resetRecaptcha();
            ...
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className=" px-26 text-center">
                ...
                <span className="mt-15 inline-block">
                  <img
                    src="/src/images/auth/Forgot password-amico.png"
                    alt="forgotPassword"
                    className="w-90"
                  />
                </span>
